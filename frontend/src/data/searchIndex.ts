...
export const USER_PAGES: SearchPage[] = [
  ...
  {
    title: '무빙 프로젝트',
    desc: '이사 현장 기록과 실적 — 갤러리·포트폴리오·브이로그.',
    path: '/projects',
    icon: '📋',
    keywords: ['무빙프로젝트', '프로젝트', '실적', '갤러리', '포트폴리오', '브이로그'],
  },
  {
    title: '프로젝트 갤러리',
    desc: '사진과 글로 기록한 이사 현장 이야기.',
    path: '/projects/gallery',
    icon: '🖼️',
    keywords: ['갤러리', '프로젝트갤러리', '사진', '블로그', '무빙프로젝트'],
  },
  {
    title: '포트폴리오',
    desc: '대표 이사·서비스 사례 모음.',
    path: '/projects/portfolio',
    icon: '📁',
    keywords: ['포트폴리오', '사례', '실적', '무빙프로젝트'],
  },
  {
    title: '무빙 브이로그',
    desc: '영상으로 보는 이사 현장.',
    path: '/projects/vlog',
    icon: '🎬',
    keywords: ['브이로그', '무빙브이로그', '영상', '비디오', '무빙프로젝트'],
  },
  {
    title: '공지사항',
